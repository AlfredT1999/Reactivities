...
export default class ActivityStore
{
    ...
    private setActivity = (activity: Activity) => {
        ...
        if(user)
        {
            // Set the activity.isGoing to true if there's some username inside the attendees array
            // that matches the current user.username that we've previously getting above:
